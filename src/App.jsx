...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB] font-sans text-slate-900 pb-20 selection:bg-[#d4af37]/30">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    {selectedChat.type === 'direct_message' 
                      ? `Chat con: ${selectedChat.adminId === user.uid ? selectedChat.userName : selectedChat.adminName}`
      ...
      {/* --- Modal de Perfil de Usuario (con pestaña Chat) --- */}
      {selectedUserProfile && (
                      ...
                      .map(chat => {
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-3">
                              <img
                                src={isAdmin ? "/icon.png" : (otherUser?.avatar || "https://api.dicebear.com/7.x/avataaars/svg?seed=" + otherParticipantId)}
                                alt=""
                                className="w-12 h-12 rounded-full object-cover"
                              />
                              <div className="flex-1">
                                <div className="flex justify-between items-start">
                                  <h4 className="font-bold">
                                    {isAdmin ? "Administración" : (otherUser?.name || "Usuario")}
                                  </h4>
                                  <span className="text-[8px] text-slate-400">
