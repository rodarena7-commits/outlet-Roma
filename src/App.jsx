...
export default function App() {
  ...
  // Función para iniciar chat directo desde admin
                        ...
                        >
                          <div className="flex gap-3">
                            <div className="relative">
                              <img
                                src={chat.type === 'direct_message' 
                                  ? (chat.adminId === user.uid ? chat.userAvatar : chat.adminAvatar)
                                  : chat.productImage
                                }
                                alt=""
                            ...
                            <div className="flex-1">
                              <div className="flex justify-between items-start">
                                <h4 className="font-bold text-sm">
                                  {chat.type === 'direct_message' 
                                    ? (chat.adminId === user.uid ? chat.userName : chat.adminName)
                                    : chat.productTitle
                                  }
                                </h4>
          ...
          <div className="relative bg-white w-full max-w-2xl rounded-[2.5rem] shadow-2xl max-h-[90vh] overflow-hidden flex flex-col">
            <div className="sticky top-0 bg-white z-10 p-6 border-b flex justify-between items-center">
              <div className="flex items-center gap-3">
                <img
                  src={selectedChat.type === 'direct_message' 
                    ? (selectedChat.adminId === user.uid ? selectedChat.userAvatar : selectedChat.adminAvatar)
                ...
                <div>
                  <h2 className="text-xl font-bold">
                    {selectedChat.type === 'direct_message' 
                      ? (selectedChat.adminId === user.uid ? selectedChat.userName : selectedChat.adminName)
                      : `Chat sobre: ${selectedChat.productTitle}`
                    }
                  </h2>
                  <p className="text-xs text-slate-500">
                    {selectedChat.type === 'direct_message' 
                      ? 'Chat directo con +Roma'
                      : `Producto: ${selectedChat.productTitle}`
                    }
                  </p>
                </div>
              </div>
