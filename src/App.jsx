...
export default function App() {
  ...
  const [isChatsPanelOpen, setIsChatsPanelOpen] = useState(false); // Nuevo panel de chats
  ...
  const toggleSoldStatus = async (productId, currentSold) => {
    ...
    if (!newSold) {
      ...
      // Si se marca como vendido sin comprador, dejamos buyerId null
    }
  ...
  <div className="container mx-auto px-4">
    <div className="flex flex-wrap items-center justify-center gap-6 md:gap-8">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="text-slate-500 hover:text-[#25D366] transition-colors p-2"
        title="WhatsApp"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
...
<a
  ...
  target="_blank"
  rel="noopener noreferrer"
  className="text-slate-500 hover:text-[#FFE600] transition-colors p-2"
  title="MercadoLibre"
>
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
